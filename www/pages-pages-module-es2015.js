...
/* harmony import */ var _pages_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages.page */ "./src/app/home/pages/pages.page.ts");
...
PagesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [
            _pages_page__WEBPACK_IMPORTED_MODULE_5__["PagesComponent"]
        ]
    })
], PagesModule);
...
/* harmony import */ var _create_page_create_page_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./create-page/create-page.page */ "./src/app/home/pages/create-page/create-page.page.ts");
/* harmony import */ var _create_partial_create_partial_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./create-partial/create-partial.page */ "./src/app/home/pages/create-partial/create-partial.page.ts");
...
/* harmony import */ var brace_mode_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! brace/mode/css */ "./node_modules/brace/mode/css.js");
/* harmony import */ var brace_mode_css__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(brace_mode_css__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var brace_mode_handlebars__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! brace/mode/handlebars */ "./node_modules/brace/mode/handlebars.js");
/* harmony import */ var brace_mode_handlebars__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(brace_mode_handlebars__WEBPACK_IMPORTED_MODULE_10__);
...
/* harmony import */ var brace_theme_github__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! brace/theme/github */ "./node_modules/brace/theme/github.js");
/* harmony import */ var brace_theme_github__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(brace_theme_github__WEBPACK_IMPORTED_MODULE_12__);
...
let PagesComponent = class PagesComponent {
    constructor(route, dataMngr, modal) {
        this.route = route;
    ...
    onNewPage() {
        const modal = this.modal.open(_create_page_create_page_page__WEBPACK_IMPORTED_MODULE_3__["CreatePageComponent"], {
            width: '350',
    ...
    onNewPartial() {
        const modal = this.modal.open(_create_partial_create_partial_page__WEBPACK_IMPORTED_MODULE_4__["CreatePartialComponent"], {
            width: '350',
        });
    ...
    onGetPages() {
        this.dataMngr.post('get-pages', { domain: this.dataMngr.user.domain, parent: this.parentId }).then((result) => {
            if (result) {
    ...
    openPartial(file) {
        ...
        if (this.code[file]) {
            ...
            this.dataMngr.get(path).then((fileData) => {
    ...
    deletePartial(file) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
            ...
            this.dataMngr.post('delete-partial', { file: file }).then((data) => {
                if (data.ok) {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire('Deleted!', `Partial ${file} has been deleted.`, 'success');
                    this.onGetPages();
                }
            });
        });
...
PagesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./pages.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/home/pages/pages.page.html")).default,
        selector: 'app-pages',
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./pages.page.scss */ "./src/app/home/pages/pages.page.scss")).default]
    })
], PagesComponent);
