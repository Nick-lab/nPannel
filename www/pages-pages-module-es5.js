...
module.exports = ".page-head {\n  padding-bottom: 15px;\n}\n\n.ace {\n  position: absolute;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var brace_mode_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! brace/mode/css */ "./node_modules/brace/mode/css.js");
/* harmony import */ var brace_mode_css__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(brace_mode_css__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var brace_mode_handlebars__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! brace/mode/handlebars */ "./node_modules/brace/mode/handlebars.js");
/* harmony import */ var brace_mode_handlebars__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(brace_mode_handlebars__WEBPACK_IMPORTED_MODULE_8__);
...
/* harmony import */ var brace_theme_github__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! brace/theme/github */ "./node_modules/brace/theme/github.js");
/* harmony import */ var brace_theme_github__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(brace_theme_github__WEBPACK_IMPORTED_MODULE_10__);
...
var PagesComponent = /** @class */ (function () {
    function PagesComponent(route, dataMngr, modal) {
        ...
        this.route.params.subscribe(function (params) {
            _this.parentId = _this.route.snapshot.paramMap.get('id') || false;
            _this.onGetPages();
            _this.code = {};
        });
    }
    PagesComponent.prototype.onNewPage = function () {
        var _this = this;
    ...
    PagesComponent.prototype.onGetPages = function () {
        var _this = this;
        this.dataMngr.post('get-pages', { domain: this.dataMngr.user.domain, parent: this.parentId }).then(function (result) {
            if (result) {
    ...
    PagesComponent.prototype.openCode = function (file) {
        var _this = this;
        var path;
        var mode;
    ...
    PagesComponent.prototype.onSaveCode = function () {
        var _this = this;
        var formData = new FormData();
        new Promise(function (res) {
            Object.keys(_this.code).forEach(function (key, index) {
                var path;
                console.log('Saving:', _this.code[key]);
                var blob = new Blob([_this.code[key]]);
                switch (key) {
                    case 'template':
                        path = '/views/' + _this.parentId + '.hbs';
                        break;
                    case 'script':
                        path = '/page_scripts/' + _this.parentId + '.js';
                        break;
                    case 'style':
                        path = '/resources/css/' + _this.parentId + '.css';
                        break;
                }
                formData.append(key + '-path', path);
                formData.append(key, blob);
                if (Object.keys(_this.code).length - 1 === index) {
                    res();
                }
            });
        }).then(function () {
            _this.dataMngr.filePost('save-code', formData).then(function (result) {
            });
        });
    };
    ...
    PagesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            template: __webpack_require__(/*! raw-loader!./pages.page.html */ "./node_modules/raw-loader/index.js!./src/app/home/pages/pages.page.html"),
            selector: 'app-pages',
            styles: [__webpack_require__(/*! ./pages.page.scss */ "./src/app/home/pages/pages.page.scss")]
        })
    ], PagesComponent);
